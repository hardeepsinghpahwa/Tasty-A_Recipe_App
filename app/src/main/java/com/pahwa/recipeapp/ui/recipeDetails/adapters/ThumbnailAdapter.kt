package com.pahwa.recipeapp.ui.recipeDetails.adapters
...
import com.pahwa.recipeapp.databinding.ThumbnailItemBinding
        ...
        with(holder) {
            with(items[position]) {
                ...
                binding.root.setOnClickListener {
                    listener.onThumbnailClick("http://www.themealdb.com/images/ingredients/${this}.png")
                }
            }
...
interface ThumbnailClickListener {
    fun onThumbnailClick(mealId: String)
}
